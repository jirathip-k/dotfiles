return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>br", dap.run_to_cursor, { desc = "Run to cursor", noremap = true, silent = true })

        vim.keymap.set("n", "<leader>b?", function()
            require("dapui").eval(nil, { enter = true })
        end, { desc = "Eval var under cursor", noremap = true, silent = true })

        vim.keymap.set("n", "<leader>bc", dap.continue, { desc = "Continue", noremap = true, silent = true })
        ...
        vim.keymap.set("n", "<leader>bs", dap.restart, { desc = "Restart", noremap = true, silent = true })
